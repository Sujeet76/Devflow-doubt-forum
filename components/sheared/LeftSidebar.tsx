...
const LeftSidebar = () => {
  ...
  return (
    <aside className='background-light900_dark200 light-border sticky left-0 top-0 flex h-screen flex-col justify-between gap-6 overflow-y-auto border-r px-4 pb-6 pt-36 shadow-light-300 dark:shadow-none max-sm:hidden lg:w-[240px]'>
